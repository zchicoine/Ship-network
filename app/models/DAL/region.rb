...
class Region
    ...
    REGIONS_HASH = {"North America" => ["Bahamas", "Belize", "Bermuda", "Canada", "Costa Rica", "Cuba", "Dominican Republic", "El Salvador", "Greenland", "Guatemala", "Haiti", "Honduras", "Jamaica", "Mexico", "Montserrat","Nicaragua", "Panama", "Saint Barthélemy","United States"],
                    "South America" =>["Antigua & Barbuda", "Argentina", "Barbados", "Bonaire, Sint Eustatius and Saba","Brazil","Chile", "Colombia", "Curaçao", "Dominica", "Ecuador", "French Guiana", "Grenada", "Guadeloupe", "Guyana", "Martinique", "Peru", "Saint Lucia" ,"St Kitts and Nevis", "St Lucia", "St Vincent and the Grenadines", "Suriname", "Trinidad and Tobago" , "Uruguay", "Venezuela"],
                    "Europe"        =>["Albania", "Belgium", "Bulgaria", "Croatia", "Cyprus", "Denmark","Estonia","Faroe Islands", "Finland", "France", "Georgia", "Germany", "Gibraltar","Greece", "Iceland", "Ireland", "Israel", "Italy", "Latvia","Lebanon", "Lithuania","Malta","Montenegro","Netherlands", "Norway","Poland" ,"Portugal", "Romania", "Russian Arctic", "Russian Black Sea", "Serbia & Montenegro", "Slovenia", "Spain", "Sweden","Switzerland", "Syria", "The Netherlands","Turkey", "Ukraine", "United Kingdom"],
                    ...
                    "Australia"     =>["Australia","Fiji", "French Polynesia" ,"Guam","New Caledonia", "New Zealand", "Papua New Guinea","Tonga"],
                    "India and South East Asia" =>["Bangladesh", "Brunei", "Cambodia", "Hong Kong","India", "Indonesia", "Malaysia", "Myanmar", "Philippines", "Sri Lanka", "Thailand", "Timor-leste", "Vietnam"],
