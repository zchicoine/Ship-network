...
#open("db/data/port_db.txt") do |ports|
    ports.read.each_line do |port|
      ...
      # end
      begin
        # _shipments = create_random_shipments
    ...
    ships.read.each_line do |ship|
      ...
      unless _port_associate_to_ship.blank?
        begin
            ...
            _shipment = [Shipment.new(open_start_date: start_date, open_end_date: start_date.advance({days: 5}), port:_port_associate_to_ship)]
